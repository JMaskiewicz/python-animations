...
FPS = 90
MAX_SPEED = 6  # Maximum speed of objects
BALL_RADIUS = 15
...
# Setup video writer
video_writer = imageio.get_writer(r'C:\Users\jmask\OneDrive\Pulpit\videos\video_30\simulation.mp4', fps=FPS)
...
figures = [
    {"sides": 80, "color": (0, 255, 255), "hole_size": 10, "rotation_speed": -0.015, "scale": 1.5}
]
...
while running:
    ...
    if not show_end_message:
        ...
        vertices, hole_indices = draw_polygon(figures[figure_index]["sides"], figures[figure_index]["color"],
...
final_audio.export(r'C:\Users\jmask\OneDrive\Pulpit\videos\video_30\simulation_sound.mp3', format="mp3")
...
video_clip = VideoFileClip(r'C:\Users\jmask\OneDrive\Pulpit\videos\video_30\simulation.mp4')
audio_clip = AudioFileClip(r'C:\Users\jmask\OneDrive\Pulpit\videos\video_30\simulation_sound.mp3')

# Trim the audio clip to match the duration of the video clip
audio_clip = audio_clip.subclip(0, video_clip.duration)

final_clip = video_clip.set_audio(audio_clip)
final_clip.write_videofile(r'C:\Users\jmask\OneDrive\Pulpit\videos\video_30\final_output.mp4', codec="libx264")
