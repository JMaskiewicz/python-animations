...
# Constants
FPS, MAX_SPEED, TRAIL_LENGTH, GRAVITY, ROTATION_SPEED = 60, 8, 20, 0.25, 0.02
...
polygons = [Polygon(polygon_centers[0], radius) for radius in [350, 300, 250, 200, 150, 100, 50]]
...
while running:
    ...
    screen.fill(BLACK)
    if not game_over:
        title_text = font.render("CAN IT GET IT?", True, WHITE)
