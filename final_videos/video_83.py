...
square_speed_increase = 1.0025  # Speed increase for each bounce
shrink_speed = 1  # Speed at which the large square shrinks
...
while running:
    ...
    if current_time - start_time > 49 and not show_end_message:
    ...
    if show_end_message:
        for offset in range(5, 0, -1):
            ...
            # Render the text with a hue-shifting effect
            game_over_text1 = large_font.render("LIKE", True, hue_border_color)
            game_over_text2 = large_font.render("FOLLOW", True, hue_border_color)
            game_over_text3 = large_font.render("SUBSCRIBE", True, hue_border_color)
            game_over_text4 = large_font.render("COMMENT WHAT TO DO NEXT", True, hue_border_color)

            # Blit each hue-shifted text onto the window with a slight offset
            window.blit(game_over_text1,
                        (WIDTH // 2 - game_over_text1.get_width() // 2 + offset, HEIGHT // 2 - 350 + offset))
            window.blit(game_over_text2,
                        (WIDTH // 2 - game_over_text2.get_width() // 2 + offset, HEIGHT // 2 - 250 + offset))
            window.blit(game_over_text3,
                        (WIDTH // 2 - game_over_text3.get_width() // 2 + offset, HEIGHT // 2 + 150 + offset))
            window.blit(game_over_text4,
                        (WIDTH // 2 - game_over_text4.get_width() // 2 + offset, HEIGHT // 2 + 250 + offset))
        ...
        window.blit(game_over_text1, (WIDTH // 2 - game_over_text1.get_width() // 2, HEIGHT // 2 - 350))
        window.blit(game_over_text2, (WIDTH // 2 - game_over_text2.get_width() // 2, HEIGHT // 2 - 250))
        window.blit(game_over_text3, (WIDTH // 2 - game_over_text3.get_width() // 2, HEIGHT // 2 + 150))
        window.blit(game_over_text4, (WIDTH // 2 - game_over_text4.get_width() // 2, HEIGHT // 2 + 250))
