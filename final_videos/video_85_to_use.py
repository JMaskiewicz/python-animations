...
# Ball settings for all three balls
BALL_RADIUS = 5

ball1_pos = [WIDTH // 2, BALL_RADIUS]  # Starting at the top center of the circle
ball1_speed = [-5, 5]

ball2_pos = [WIDTH // 2, BALL_RADIUS]  # Starting at the same position but with delay
ball2_speed = [-5, 5]

ball3_pos = [WIDTH // 2, BALL_RADIUS]  # Third ball also starts at the top
ball3_speed = [-5, 5]

# New trail settings for the third ball
trail_positions_3 = []
...
hue_value_3 = 90   # Initial hue value for ball 3
...
while running:
    ...
    # Update ball 1 immediately
    ball1_speed = update_ball(ball1_pos, ball1_speed, trail_positions_1, hue_value_1)

    # Update ball 2 after 0.5 seconds delay
    if elapsed_time > 0.5:
        ball2_speed = update_ball(ball2_pos, ball2_speed, trail_positions_2, hue_value_2)

    # Update ball 3 after 1 second delay
    if elapsed_time > 1:
        ball3_speed = update_ball(ball3_pos, ball3_speed, trail_positions_3, hue_value_3)

    # Update hue values for all three balls
    hue_value_1 += 2
    hue_value_2 += 2
    hue_value_3 += 2
    ...
    for pos, radius in trail_positions_3:
        pygame.draw.circle(screen, get_hue_color(hue_value_3), pos, radius, 1)
    ...
    pygame.draw.circle(screen, BLACK, ball3_pos, BALL_RADIUS + 5)
    ...
    pygame.draw.circle(screen, get_hue_color(hue_value_3), ball3_pos, BALL_RADIUS)  # Ball 3
