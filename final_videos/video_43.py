...
BALL_GROWTH_RATE = 1.03  # Growth rate of the ball
...
while running:
    ...
    if not game_over:
        ...
        title_text = font.render("EXPANDING BALL", True, WHITE)
        screen.blit(title_text, (WIDTH // 2 - title_text.get_width() // 2, 100))

        # Draw lines from hit points on the circle to the center of the ball
