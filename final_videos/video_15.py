...
TRIANGLE_SHRINK_RATE = 2  # Rate at which triangles shrink
NEW_TRIANGLE_INTERVAL = 0.25  # Initial time interval in seconds to add new triangle
    ...
    if not game_over:
        ...
        if triangles:
            ...
            if current_time - last_triangle_add_time >= NEW_TRIANGLE_INTERVAL:
                new_triangle = Triangle(800, TRIANGLE_COLOR, 0.02)
