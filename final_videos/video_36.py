...
NEW_SQUARE_INTERVAL = 0.1  # Initial time interval in seconds to add new square
...
balls = [
    Ball([WIDTH // 2 + 25, HEIGHT // 2], [random.choice([-MAX_SPEED, MAX_SPEED]), random.choice([-MAX_SPEED, MAX_SPEED])]),
    Ball([WIDTH // 2 - 25, HEIGHT // 2], [random.choice([-MAX_SPEED, MAX_SPEED]), random.choice([-MAX_SPEED, MAX_SPEED])])
]
