...
CIRCLE_SHRINK_RATE = 1.5  # Rate at which squares shrink
...
SQUARE_CREATION_ACCELERATION = 0.9975  # Factor to decrease interval for square creation after each bounce

# Colors
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
SQUARE_COLORS = [(0, 191, 255), (30, 144, 255), (100, 149, 237), (70, 130, 180), (135, 206, 235)]
...
squares = [Square(side_length, random.choice(SQUARE_COLORS), 0.01, initial_angle=initial_angles[i % len(initial_angles)]) for i, side_length in enumerate(range(700, 300, -50))]
    ...
    if not game_over:
        ...
        if squares:
            ...
            if current_time - last_square_add_time >= NEW_SQUARE_INTERVAL:
                new_square = Square(700, random.choice(SQUARE_COLORS), 0.01)
