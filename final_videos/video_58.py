...
# Initial positions of the squares (center of the screen, offset by square size)
square1_pos = [WIDTH / 2 - square_size / 2, HEIGHT / 2 - square_size / 2]  # Top-left
square2_pos = [WIDTH / 2 + square_size / 2, HEIGHT / 2 - square_size / 2]  # Top-right
square3_pos = [WIDTH / 2 - square_size / 2, HEIGHT / 2 + square_size / 2]  # Bottom-left
square4_pos = [WIDTH / 2 + square_size / 2, HEIGHT / 2 + square_size / 2]  # Bottom-right

# Velocities of the squares
square1_vel = [-6, -6]  # Moving to the top-left
square2_vel = [6, -6]   # Moving to the top-right
square3_vel = [-6, 6]   # Moving to the bottom-left
square4_vel = [6, 6]    # Moving to the bottom-right

# Speed increase factor
speed_increase_factor = 1.015
...
while running:
    ...
    title_text = font.render("Hypnotic Geometric Dance", True, WHITE)
